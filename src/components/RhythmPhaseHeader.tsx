      ...
      <div className="eb-hero-header">
        ...
        <div className="text-right shrink-0 flex flex-col items-end gap-2">
          ...
          <div>
            ...
            <div className="text-sm font-medium text-white">{props.confidenceLabel}</div>
          </div>
        </div>
      </div>
      {props.timingCopy ? (
        <div className="mt-3 eb-hero-subtitle eb-hero-on-dark-muted text-white">{props.timingCopy}</div>
      ) : null}
      <div className="mt-3">
